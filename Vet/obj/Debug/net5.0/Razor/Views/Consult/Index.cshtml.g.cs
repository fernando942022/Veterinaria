#pragma checksum "C:\Users\FFernandez\source\repos\Vet\Vet\Views\Consult\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "07052ea9e896ba0e4eb1afd7fa923ac4d9730f10"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"07052ea9e896ba0e4eb1afd7fa923ac4d9730f10", @"/Views/Consult/Index.cshtml")]
...
#line 27 "C:\Users\FFernandez\source\repos\Vet\Vet\Views\Consult\Index.cshtml"
                     Write(Html.TextAreaFor(model => model.MedicalChart, new { @class = "form-control", @placeholder = "Medical chart", @id = "summernote" }));
...
#nullable disable
            ...
            $(""#btnSave"").click(function () {
                ...
                //var dataConsult = getRecord(ownerId);

                $.ajax({
                url: """);
#nullable restore
#line 114 "C:\Users\FFernandez\source\repos\Vet\Vet\Views\Consult\Index.cshtml"
        ...
        function result(data) {
            ...
            $.each(data, function (index, row) {
                ...
                if (nameOwner != data[index][""name""]) {
                    headerOwner.append(""<dt><h3>"" + data[index][""name""] + ""Pet </h3><h6");
                WriteLiteral(@">("" + data[index][""homeAddress""] + "", "" + data[index][""cellphone""] + "")</h6></dt>"");
                ...
                //table.append(""< td ><button onclick='edit("" + data[index][""petId""] + "");' class='btn btn-primary' id='edit'>Edit");
                ...
                table.append(""<td");
                WriteLiteral(@" style='text-align:center'>"" + data[index][""comment""] + ""</td>"");
